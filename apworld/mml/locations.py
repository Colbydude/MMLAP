...
LOCATION_DATA_DICT = {
   ...
   #"Yass plains, Across hideout pail"                              : LocationData(22,  LocationCategory.CONTAINER, False),
    ...
    "Underground ruins, Shekuten platform room chest"               : LocationData(35,  LocationCategory.CONTAINER, False),
    "Underground ruins, Shekuten platform room hole"                : LocationData(36,  LocationCategory.CONTAINER, False),
    ...
    "Clozer Woods Sub-Gate, Sharukurusu E room left hole"           : LocationData(73,  LocationCategory.CONTAINER, False),
    "Clozer Woods Sub-Gate, Sharukurusu E room right hole"          : LocationData(74,  LocationCategory.CONTAINER, False),
