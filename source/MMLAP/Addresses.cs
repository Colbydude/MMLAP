...
namespace MMLAP
{
    public static class Addresses
    {
        ...
        // Inspector quest
        public static readonly AddressData StartBombQuest = new(0xBE3B8, 3, null); // bombs go off = 0xBE3B8 2 and 1, BE3D4 1, turn in to inpector 0xBE3B8 0
        ...
        public static readonly AddressData BagPailIsReady = new(0xBE3B9, 7, null);
        public static readonly AddressData TurnInBagQuest = new(0xBE3Ba, 6, null);
        // Main story flags
